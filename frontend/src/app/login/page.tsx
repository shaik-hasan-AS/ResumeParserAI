    ...
    <div className="flex items-center justify-center min-h-screen mesh-bg relative overflow-hidden p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400">Login to your ResumeIQ account</p>
        </div>
        ...
        <p className="text-sm text-center text-zinc-400 mt-6">
          Don't have an account? <Link href="/register" className="text-purple-400 hover:text-purple-300 transition-colors font-medium">Register</Link>
        </p>
      </motion.div>
    </div>
  );
