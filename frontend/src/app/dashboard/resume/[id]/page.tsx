...
export default function ResumeViewer() {
  ...
  const [activeTab, setActiveTab] = useState<'strengths' | 'improvements' | 'action_plan' | 'rewrites' | 'cover_letter'>('strengths');
  const [pdfTheme, setPdfTheme] = useState<'modern' | 'harvard'>('modern');
